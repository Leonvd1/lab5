...
namespace Компьютерный
{
	partial class поиск_клиента
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(62, 218);
			...
			this.Name = "поиск_клиента";
			this.Text = "поиск_клиента";
			this.Load += new System.EventHandler(this.поиск_клиента_Load);
